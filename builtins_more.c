 ...
 * Return: 0 if success, else other num in args
 */
 ...
 * @data: struct for program data
 * Return: 0 if success, else other num in arg
 */
 ...
 * Return: 0 if successful, else nume declared in args
 */
 ...
 * @data: struct for program data
 * Return: 0 if successful, else num in args
 */
 ...
 * Return: 0 if successful, else other num in args
 */
