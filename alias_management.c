...
/**
 * print_alias - shows or adds or deletes an alias
 * @data: struct for data
 * @alias: alias to be printed
 * Return: 0 if success, or num declared in arg
 */
 ...
 * @alias_string: alias to be seted in form(name ='value')
 * @data: struct for program data
 * Return: 0 if success, else other num declared in args
 */
